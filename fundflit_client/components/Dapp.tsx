...
export class Dapp extends React.Component<DappProps, DappState> {
  ...
  _pollDataInterval: NodeJS.Timeout | undefined;
    ...
    if (!this.state.selectedAddress) {
      return (
        <ConnectWallet
          ...
          networkError={this.state.networkError as string | null}
      ...
      <div className="container p-4">
        <div className="row">
          <div className="col-12">
            <p>
              wallet address: <b>{this.state.selectedAddress}</b>
            </p>
            <p>
              Balance:{" "}
              <b>
  ...
  async _getTokenData() {
    //alert(JSON.stringify(this._token);
  ...
  async _switchChain() {
    ...
    this._initialize(this.state.selectedAddress as string);
  }
