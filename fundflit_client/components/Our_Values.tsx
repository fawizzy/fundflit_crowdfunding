            ...
            <div className=" md:w-[60%] xs:w-[70%] w-[85%] flex flex-col items-center justify-between gap-10 mt-10">
                {values.map((value) => (
                    <div key={value.value} className=" w-full flex justify-between">
                        <div className="w-[22%] ">
                            <img src={value.imgUrl} alt="" className=" object-cover lg:h-[7rem] lg:w-[7rem] sm:h-[5.5rem] sm:w-[5.5rem] h-[4rem] w-[4rem] rounded-md relative top-1" />
                        </div>
                        <div className="w-[72%] ">
                            <h3 className=" md:text-[1.75rem] text-[1.35rem] md:mb-5 mb-2">{value.value}</h3>
